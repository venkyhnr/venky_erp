    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Frequency</h3>
                    <ul class="breadcrumb">
                ...
                @if (in_array('20', $add_perm) || in_array('20', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('20', $add_perm))
                        <a class="btn btn-primary me-1" href="{{  route('frequencies.create') }}">
                            <i class="fas fa-plus"></i> Add Frequency
                        </a>
                        @endif
                        @if (in_array('20', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('frequencies.delete') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('20', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{  route('frequencies.edit', $data->id) }}"><i
...
@section('footer_js')
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-text text-center">
                        <!-- <h3>Delete Expense Frequency</h3> -->
    ...
    <!-- /Delete Frequency Modal -->
    <!-- Select one record Frequency Modal -->
 ...
 <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
         <div class="modal-body">
             <div class="modal-text text-center">
                 <h3>Are you sure you want to Set order of Frequency</h3>
