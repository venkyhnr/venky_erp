            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Industry Type</li>
                    </ul>
                </div>
                @if (in_array('17', $add_perm) || in_array('17', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('17', $add_perm))
                        <a class="btn btn-primary me-1" href="{{  route('industry-type.create') }}">
                            <i class="fas fa-plus"></i> Add Industry Type
                        </a>
                        @endif
                        @if (in_array('17', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('industry-type.delete') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('17', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{  route('industry-type.edit', $data->id) }}"><i
