    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('7', $add_perm) || in_array('7', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('7', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('branch.create') }}">
                            <i class="fas fa-plus"></i> Add Branch
                        </a>
                        @endif
                        @if (in_array('7', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_branch') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('7', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('branch.edit', $data->id) }}"><i
