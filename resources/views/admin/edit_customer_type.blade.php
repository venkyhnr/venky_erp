...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Edit Customer Type</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('customer_type.index') }}">Customer Type</a></li>
                        <li class="breadcrumb-item active">Edit Customer Type</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('customer_type.update', $customer_type->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input id="customer_type" name="customer_type" type="text" class="form-control"
                                        placeholder="Enter Customer Type" value="{{ $customer_type->customer_type }}" />
