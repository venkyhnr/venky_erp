    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Reference</h3>
                    <ul class="breadcrumb">
                ...
                @if (in_array('18', $add_perm) || in_array('18', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('18', $add_perm))
                        <a class="btn btn-primary me-1" href="{{  route('reference.create') }}">
                            <i class="fas fa-plus"></i> Add Reference
                        </a>
                        @endif
                        @if (in_array('18', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('reference.delete') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('18', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{  route('reference.edit', $data->id) }}"><i
...
@section('footer_js')
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-text text-center">
                        <!-- <h3>Delete Expense Reference</h3> -->
    ...
    <!-- /Delete Reference Modal -->
    <!-- Select one record Reference Modal -->
 ...
 <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
         <div class="modal-body">
             <div class="modal-text text-center">
                 <h3>Are you sure you want to Set order of Reference</h3>
