    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Title/Rank</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Title/Rank</li>
                    </ul>
                </div>
                @if (in_array('4', $add_perm) || in_array('4', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('4', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('title_rank.create') }}">
                            <i class="fas fa-plus"></i> Add Title/Rank
                        </a>
                        @endif
                        @if (in_array('4', $delete_perm))
                        <a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_title_rank();">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_title_rank') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('4', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('title_rank.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_title_rank" role="dialog">
 ...
 <div class="modal-dialog modal-dialog-centered">
    ...
    <!-- /set orderModal -->
    <script>
        function delete_title_rank() {
            // alert('test');
            var checked = $("#form input:checked").length > 0;
            if (!checked) {
                $('#select_one_record').modal('show');
            } else {
                $('#delete_title_rank').modal('show');
            }
        }
        function form_sub() {
            $('#form').submit();
