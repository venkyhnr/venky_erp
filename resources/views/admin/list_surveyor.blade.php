    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('13', $add_perm) || in_array('13', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('13', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('surveyor.create') }}">
                            <i class="fas fa-plus"></i> Add Surveyor
                        </a>
                        @endif
                        @if (in_array('13', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_surveyor') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('13', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('surveyor.edit', $data->id) }}"><i
