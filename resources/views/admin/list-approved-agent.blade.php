    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Approved Agents</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Approved Agents</li>
                    </ul>
                </div>
                @if (in_array('19', $add_perm) || in_array('19', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('19', $add_perm))
                        <a class="btn btn-primary me-1" href="{{  route('approved-agents.create') }}">
                            <i class="fas fa-plus"></i> Add Approved Agents
                        </a>
                        @endif
                        @if (in_array('19', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('approved-agent.delete') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('19', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{  route('approved-agents.edit', $data->id) }}"><i
...
@section('footer_js')
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-text text-center">
                        <!-- <h3>Delete Expense Approved Agents</h3> -->
    ...
    <!-- /Delete Approved Agents Modal -->
    <!-- Select one record Approved Agents Modal -->
 ...
 <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
         <div class="modal-body">
             <div class="modal-text text-center">
                 <h3>Are you sure you want to Set order of Approved Agents</h3>
