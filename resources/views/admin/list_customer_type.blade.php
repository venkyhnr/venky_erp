    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('5', $add_perm) || in_array('5', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('5', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('customer_type.create') }}">
                            <i class="fas fa-plus"></i> Add Customer Type
                        </a>
                        @endif
                        @if (in_array('5', $delete_perm))
                        <a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_customer_type();">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_customer_type') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('5', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('customer_type.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_customer_type" role="dialog">
    ...
    <script>
        function delete_customer_type() {
            ...
            if (!checked) {
                ...
                $('#delete_customer_type').modal('show');
            }
        }
        function form_sub() {
            $('#form').submit();
