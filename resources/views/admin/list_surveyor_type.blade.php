            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Surve Type</li>
                    </ul>
                </div>
                @if (in_array('8', $add_perm) || in_array('8', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('8', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('surveyor_type.create') }}">
                            <i class="fas fa-plus"></i> Add Surve Type
                        </a>
                        @endif
                        @if (in_array('8', $delete_perm))
                        <a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_surveyor_type();">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_surveyor_type') }}" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    ...
                                    <tbody>
                                        @foreach ($surveyor_type_data as $data)
                                            <tr>
                                                ...
                                                @if (in_array('8', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('surveyor_type.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_surveyor_type" role="dialog">
 ...
 <div class="modal-dialog modal-dialog-centered">
    ...
    <!-- /set orderModal -->
    <script>
        function delete_surveyor_type() {
            // alert('test');
            var checked = $("#form input:checked").length > 0;
            if (!checked) {
                $('#select_one_record').modal('show');
            } else {
                $('#delete_surveyor_type').modal('show');
            }
        }
        function form_sub() {
            $('#form').submit();
