...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Edit Surveyor Time Zone</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('surveyor_time_zone.index') }}">Surveyor Time Zone</a></li>
                        <li class="breadcrumb-item active">Edit Surveyor Time Zone</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('surveyor_time_zone.update', $surveyor_time_zone->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="time_zone" id="time_zone" value="{{$surveyor_time_zone->time_zone}}" class="form-control"/>
