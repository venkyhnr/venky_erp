            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Surveyor Time Zone</li>
                    </ul>
                </div>
                @if (in_array('9', $add_perm) || in_array('9', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('9', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('surveyor_time_zone.create') }}">
                            <i class="fas fa-plus"></i> Add Surveyor Time Zone
                        </a>
                        @endif
                        @if (in_array('9', $delete_perm))
                        <a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_surveyor_time_zone();">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_surveyor_time_zone') }}" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    ...
                                    <tbody>
                                        @foreach ($surveyor_time_zone as $data)
                                            <tr>
                                                ...
                                                @if (in_array('9', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('surveyor_time_zone.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_surveyor_time_zone" role="dialog">
 ...
 <div class="modal-dialog modal-dialog-centered">
    ...
    <!-- /set orderModal -->
    <script>
        function delete_surveyor_time_zone() {
            // alert('test');
            var checked = $("#form input:checked").length > 0;
            if (!checked) {
                $('#select_one_record').modal('show');
            } else {
                $('#delete_surveyor_time_zone').modal('show');
            }
        }
        function form_sub() {
            $('#form').submit();
