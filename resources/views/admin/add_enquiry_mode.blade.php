            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Enquiry Mode</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('enquiry_mode.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input id="enquiry_mode" name="enquiry_mode" type="text" class="form-control"
                                        placeholder="Enter Enquiry Mode" value="" />
