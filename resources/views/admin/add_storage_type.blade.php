            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Storage Type</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('storage_type.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input id="storage_type" name="storage_type" type="text" class="form-control"
                                        placeholder="Enter Storage Type" value="" />
